...
export default async function StartPage() {
  const [{ wiki }, guide, bannerSettings, editor] = await Promise.all([getHypedPageContext(), getOnboardingGuide(HYPED_SOCIETY_ID, HYPED_SOCIETY_NAME), getSiteBannerSettings(), getCurrentEditor()]);
  return (
